package com.example.pruebatecnicaquind.Constans;
...
public class MessageAplication {
    ...
    public static String DELETECLIENT = "Se borro la informacion del cliente correctamente";
    public static String BALANCECANNOTLESS0 = "El saldo de una cuenta de ahorros no puede ser menor a $0.";
    public static String ACCOUNTNOTFOUND = "No se encontro la cuenta";
